...
let ReviewResolver = class ReviewResolver {
    constructor(reviewServiece) {
        this.reviewServiece = reviewServiece;
    }
    async create(user, createReviewDto) {
        return this.reviewServiece.create(user, createReviewDto);
    }
};
__decorate([
    ...
    __metadata("design:paramtypes", [Object, createReview_dto_1.CreateReviewDto]),
